...
int main() {
  ...
  auto return1 = stl_list.erase(stl_iterator);
  auto return2 = our_list.erase(our_iterator);
  compare_lists(stl_list, our_list);
  ...
  return1 = stl_list.erase(stl_iterator);
  return2 = our_list.erase(our_iterator);
  compare_lists(stl_list, our_list);
  ...
  return1 = stl_list.erase(stl_start_erase, stl_end_erase);
  return2 = our_list.erase(our_start_erase, our_end_erase);
  compare_lists(stl_list, our_list);
